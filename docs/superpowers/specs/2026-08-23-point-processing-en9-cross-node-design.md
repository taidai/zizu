...
> **现行专项，部分已被取代。** 全局结论汇总见待最终复核的[核心架构总纲](./2026-08-27-zizu-platform-core-architecture-design.md)。本文件的强类型 DAG、公式 DSL 与 EN9 映射仍有效；其中解决方案资产、设备实例、迟到数据、逐实体周期/心跳、新鲜度下限和旧 outbox 语义已被后续 ADR-0013/0014 取代。
